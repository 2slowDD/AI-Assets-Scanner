...
![Version](https://img.shields.io/badge/VERSION-1.4.3-007cba?style=for-the-badge)
...
- **Menu badge for completed scans (1.4.3)** — small `!` badge next to the AAS menu item when a scan finishes while you're elsewhere in WP admin. Green for success, red for failure. Auto-clears when you visit the main AAS page. Live updates via WP Heartbeat (~15s). Also: scan-complete summary now shows URL count (`Scan complete. N URLs scanned, …`).
