...
![Version](https://img.shields.io/badge/VERSION-1.4.13-007cba?style=for-the-badge)
...
- **Two-pass probe for end-of-body cache markers (FU-NEW-7, 1.3.3 — superseded by 1.4.0 Tier 3)** — original 8KB-tail fallback for end-of-body HTML comments. Behavior preserved on Pass 1 (32KB head); Pass 2 now scans full body (see 1.4.0 entry above)
