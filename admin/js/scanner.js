(function () {
    ...
    function renderResultUrlListPage() {
        ...
        host.innerHTML =
          ...
          + '<table class="cu-url-table widefat"><thead><tr><th>#</th><th>URL</th><th>Status</th><th>Credits</th><th>S / A / N<br><span class="cu-help" tabindex="0" aria-label="Safe: high-confidence unload rules with a low risk of affecting the page — tested and confirmed safe to unload. Aggressive: broader unload rules with slightly lower confidence — tested and confirmed safe to unload. Needed: assets required by the page — they will remain loaded when you push the rules."><span class="cu-help-box"><strong>Safe:</strong> High-confidence unload rules with a low risk of affecting the page. Tested and confirmed safe to unload.<br><strong>Aggressive:</strong> Broader unload rules with slightly lower confidence. Tested and confirmed safe to unload.<br><strong>Needed:</strong> Assets required by the page. They will remain loaded when you push the rules.</span></span></th><th>ET candidate <span class="cu-help" tabindex="0" aria-label="ET candidate: URLs that would benefit from the worker spending extra time on them — likely more unloads."><span class="cu-help-box">ET candidates are URLs that would benefit from the worker spending extra time on them — likely yielding more unloads.</span></span></th><th>Extra Time <span class="cu-help" tabindex="0" aria-label="Re-run this URL with Extra Time — more probe budget, plus one credit."><span class="cu-help-box">Re-run this URL with Extra Time (more probe budget, +1 credit).</span></span></th></tr></thead><tbody>' + rows + '</tbody></table>'
